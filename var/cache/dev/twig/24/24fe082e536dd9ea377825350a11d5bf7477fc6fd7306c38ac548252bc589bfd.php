...
class __TwigTemplate_2f0bb1e0ac09e8adf932dd9b5acc9ec7da4feec02e11094795d2dbc8716bf1ae extends Template
{
    private $source;
    private $macros = [];
...
\t<div class=\"card-header py-3\">
      \t<h6 class=\"m-0 font-weight-bold text-primary text-center\">Inscription</h6>
\t</div>
\t<div class=\"card-body\">
\t\t";
        // line 11
...
\t\t";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "username", [], "any", false, false, false, 12), 'row', ["label" => "Nom d'utilisateur"]);
        echo "
\t\t";
        // line 13
...
\t\t";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "password", [], "any", false, false, false, 14), 'row', ["label" => "Mot de passe"]);
        echo "
\t\t";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "confirm_password", [], "any", false, false, false, 15), 'row', ["label" => "Confirmer votre mot de passe"]);
        echo "
...
";
    ...
    {
        return array (  116 => 17,  111 => 15,  107 => 14,  103 => 13,  99 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
\t\t{{ form_row(form.confirm_password,{'label':'Confirmer votre mot de passe'})}}
\t\t <button class=\"btn btn-primary\" type=\"submit\">S'enregistrer</button>
\t\t{{form_end(form)}}
\t</div>
</div>
{% endblock %}", "security/registration.html.twig", "/var/www/templates/security/registration.html.twig");
    }
}
